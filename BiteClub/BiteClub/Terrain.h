...
namespace terrain{
	/**
	* @class Terrain
	* @brief Encapsulates and provides access to a heightfield.
	*
	* @author Alfred Malone
	* @version 01
	...
	* @author Alfred Malone
	* @version 02
	* @date 28/4/2017 Alfred Malone, added Doxygen comments
	*/
	class Terrain{
	public:
		/**
		...
		*
		* loadHeightfield loads heightfield data from an image file.
		*/
		...
		*
		* setScale sets the terrain scale along the x, y, and z axes with x, y, and z respectively.
		*/
		...
		* and length are equal (or should be).
		*/
		int getTerrainSize();
		/**
	...
	private:
		...
		/**
		* @brief Checks if an XZ co-ordinate is within the bounds of the heightfield's elements.
		...
		*
		* getHeightColour is a function only used for a simple colouring of the heightfield,
		* using the colour each point has from the image file.
		*/
